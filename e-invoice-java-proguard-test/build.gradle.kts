...
dependencies {
    testImplementation(project(":e-invoice-java"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../e-invoice-java-core/src/main/resources/META-INF/proguard/e-invoice-java-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("com.e_invoice.api.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../e-invoice-java-core/src/main/resources/META-INF/proguard/e-invoice-java-core.pro",
