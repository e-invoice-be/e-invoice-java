...
internal class OutboxListReceivedDocumentsParamsTest {

    @Test
    fun create() {
        OutboxListReceivedDocumentsParams.builder()
    ...
    fun queryParamsWithoutOptionalFields() {
        val params = OutboxListReceivedDocumentsParams.builder().build()
