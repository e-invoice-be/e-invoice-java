...
internal class DocumentResponseTest {
    ...
    fun create() {
        ...
        assertThat(documentResponse.charges().getOrNull())
            .containsExactly(
                DocumentResponse.Charge.builder()
                    .amount("amount")
                    .baseAmount("base_amount")
        ...
        assertThat(documentResponse.customerCompanyId()).contains("1018265814")
        ...
        assertThat(documentResponse.taxCode()).contains(DocumentResponse.TaxCode.AE)
        ...
        assertThat(documentResponse.vatex()).contains(DocumentResponse.Vatex.VATEX_EU_79_C)
        assertThat(documentResponse.vatexNote()).contains("vatex_note")
        ...
        assertThat(documentResponse.vendorCompanyId()).contains("1018265814")
        assertThat(documentResponse.vendorEmail()).contains("vendor_email")
        assertThat(documentResponse.vendorName()).contains("vendor_name")
        assertThat(documentResponse.vendorTaxId()).contains("BE1018265814")
    }
