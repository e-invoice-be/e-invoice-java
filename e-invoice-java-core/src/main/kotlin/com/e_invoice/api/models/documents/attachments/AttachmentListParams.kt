...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(attachmentListParams: AttachmentListParams) = apply {
            documentId = attachmentListParams.documentId
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AttachmentListParams && documentId == other.documentId && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(documentId, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "AttachmentListParams{documentId=$documentId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
