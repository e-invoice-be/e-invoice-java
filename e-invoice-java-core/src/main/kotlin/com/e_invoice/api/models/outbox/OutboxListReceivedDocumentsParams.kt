...
/**
 * Retrieve a paginated list of sent documents with filtering options including state, type, sender,
...
private constructor(
    ...
    /**
     * Filter by receiver (customer_name, customer_email, customer_tax_id, customer_company_id,
     * customer_id)
     */
    fun receiver(): Optional<String> = Optional.ofNullable(receiver)
    ...
    class Builder internal constructor() {
        ...
        internal fun from(outboxListReceivedDocumentsParams: OutboxListReceivedDocumentsParams) =
            apply {
                ...
                receiver = outboxListReceivedDocumentsParams.receiver
        ...
        /** Alias for calling [Builder.receiver] with `receiver.orElse(null)`. */
        fun receiver(receiver: Optional<String>) = receiver(receiver.getOrNull())
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OutboxListReceivedDocumentsParams &&
