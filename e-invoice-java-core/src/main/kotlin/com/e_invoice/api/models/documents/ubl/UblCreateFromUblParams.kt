...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [UblCreateFromUblParams].
         *
    ...
    /** A builder for [UblCreateFromUblParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(ublCreateFromUblParams: UblCreateFromUblParams) = apply {
            body = ublCreateFromUblParams.body.toBuilder()
            additionalHeaders = ublCreateFromUblParams.additionalHeaders.toBuilder()
            additionalQueryParams = ublCreateFromUblParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [UblCreateFromUblParams].
         *
         ...
         */
        fun build(): UblCreateFromUblParams =
            UblCreateFromUblParams(
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UblCreateFromUblParams &&
            body == other.body &&
    ...
    override fun toString() =
        "UblCreateFromUblParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
