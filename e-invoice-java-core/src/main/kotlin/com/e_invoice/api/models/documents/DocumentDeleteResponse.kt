...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(documentDeleteResponse: DocumentDeleteResponse) = apply {
            isDeleted = documentDeleteResponse.isDeleted
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is DocumentDeleteResponse && isDeleted == other.isDeleted && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "DocumentDeleteResponse{isDeleted=$isDeleted, additionalProperties=$additionalProperties}"
}
