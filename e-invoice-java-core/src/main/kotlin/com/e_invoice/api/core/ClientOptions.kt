...
package com.e_invoice.api.core

import com.e_invoice.api.core.http.AsyncStreamResponse
import com.e_invoice.api.core.http.Headers
import com.e_invoice.api.core.http.HttpClient
import com.e_invoice.api.core.http.LoggingHttpClient
import com.e_invoice.api.core.http.PhantomReachableClosingHttpClient
import com.e_invoice.api.core.http.QueryParams
import com.e_invoice.api.core.http.RetryingHttpClient
...
private constructor(
     ...
     *
     * Use the one published in `e-invoice-java-client-okhttp` or implement your own.
     *
     ...
     *
     * Defaults to [com.e_invoice.api.core.jsonMapper]. The default is usually sufficient and rarely
     ...
     *
     * Defaults to the production environment: `https://api.e-invoice.be`.
     */
    ...
    class Builder internal constructor() {
         ...
         * The Jackson JSON mapper to use for serializing and deserializing JSON.
         *
         * Defaults to [com.e_invoice.api.core.jsonMapper]. The default is usually sufficient and
        ...
        fun fromEnv() = apply {
            ...
            System.getenv("E_INVOICE_CUSTOM_HEADERS")?.let { customHeadersEnv ->
                            ...
                            object : ThreadFactory {
                                ...
                                override fun newThread(runnable: Runnable): Thread =
                                    threadFactory.newThread(runnable).also {
                                        it.name =
                                            "e-invoice-stream-handler-thread-${count.getAndIncrement()}"
                                    }
                            }
                        )
                    )
