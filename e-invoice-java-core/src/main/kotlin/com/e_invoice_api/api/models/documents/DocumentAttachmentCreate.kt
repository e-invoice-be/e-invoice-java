...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is DocumentAttachmentCreate && fileName == other.fileName && fileData == other.fileData && fileSize == other.fileSize && fileType == other.fileType && additionalProperties == other.additionalProperties /* spotless:on */
    }

    /* spotless:off */
    private val hashCode: Int by lazy { Objects.hash(fileName, fileData, fileSize, fileType, additionalProperties) }
    /* spotless:on */
