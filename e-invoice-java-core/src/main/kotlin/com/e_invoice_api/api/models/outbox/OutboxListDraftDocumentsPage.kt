...
import com.e_invoice_api.api.core.AutoPager
import com.e_invoice_api.api.core.Page
...
import com.e_invoice_api.api.services.blocking.OutboxService
...
private constructor(
    ...
    override fun nextPage(): OutboxListDraftDocumentsPage =
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OutboxListDraftDocumentsPage].
         *
    ...
    /** A builder for [OutboxListDraftDocumentsPage]. */
    class Builder internal constructor() {

        private var service: OutboxService? = null
        private var params: OutboxListDraftDocumentsParams? = null
        private var response: PaginatedDocumentResponse? = null

        @JvmSynthetic
        internal fun from(outboxListDraftDocumentsPage: OutboxListDraftDocumentsPage) = apply {
            service = outboxListDraftDocumentsPage.service
            params = outboxListDraftDocumentsPage.params
            response = outboxListDraftDocumentsPage.response
        }

        fun service(service: OutboxService) = apply { this.service = service }
        ...
        /**
         * Returns an immutable instance of [OutboxListDraftDocumentsPage].
         *
         ...
         */
        fun build(): OutboxListDraftDocumentsPage =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is OutboxListDraftDocumentsPage && service == other.service && params == other.params && response == other.response /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(service, params, response) /* spotless:on */

    override fun toString() =
        "OutboxListDraftDocumentsPage{service=$service, params=$params, response=$response}"
}
