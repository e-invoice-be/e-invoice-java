...
import com.e_invoice_api.api.core.AutoPagerAsync
import com.e_invoice_api.api.core.PageAsync
...
/** @see [OutboxServiceAsync.listDraftDocuments] */
class OutboxListDraftDocumentsPageAsync
private constructor(
    private val service: OutboxServiceAsync,
    private val streamHandlerExecutor: Executor,
    private val params: OutboxListDraftDocumentsParams,
    ...
    override fun nextPage(): CompletableFuture<OutboxListDraftDocumentsPageAsync> =
        service.listDraftDocuments(nextPageParams())

    fun autoPager(): AutoPagerAsync<DocumentResponse> =
        AutoPagerAsync.from(this, streamHandlerExecutor)

    /** The parameters that were used to request this page. */
    fun params(): OutboxListDraftDocumentsParams = params
    ...
    companion object {
         ...
         * [OutboxListDraftDocumentsPageAsync].
         *
    ...
    /** A builder for [OutboxListDraftDocumentsPageAsync]. */
    class Builder internal constructor() {

        private var service: OutboxServiceAsync? = null
        private var streamHandlerExecutor: Executor? = null
        private var params: OutboxListDraftDocumentsParams? = null
        private var response: PaginatedDocumentResponse? = null

        @JvmSynthetic
        internal fun from(outboxListDraftDocumentsPageAsync: OutboxListDraftDocumentsPageAsync) =
            apply {
                service = outboxListDraftDocumentsPageAsync.service
                streamHandlerExecutor = outboxListDraftDocumentsPageAsync.streamHandlerExecutor
                params = outboxListDraftDocumentsPageAsync.params
                response = outboxListDraftDocumentsPageAsync.response
            }
        ...
        /** The parameters that were used to request this page. */
        fun params(params: OutboxListDraftDocumentsParams) = apply { this.params = params }

        /** The response that this page was parsed from. */
        fun response(response: PaginatedDocumentResponse) = apply { this.response = response }

        /**
         * Returns an immutable instance of [OutboxListDraftDocumentsPageAsync].
         *
         ...
         */
        fun build(): OutboxListDraftDocumentsPageAsync =
            OutboxListDraftDocumentsPageAsync(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is OutboxListDraftDocumentsPageAsync && service == other.service && streamHandlerExecutor == other.streamHandlerExecutor && params == other.params && response == other.response /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(service, streamHandlerExecutor, params, response) /* spotless:on */

    override fun toString() =
        "OutboxListDraftDocumentsPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, response=$response}"
}
