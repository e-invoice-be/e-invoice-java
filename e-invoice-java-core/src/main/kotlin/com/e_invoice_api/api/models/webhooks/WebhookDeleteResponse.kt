...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(webhookDeleteResponse: WebhookDeleteResponse) = apply {
            isDeleted = webhookDeleteResponse.isDeleted
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is WebhookDeleteResponse && isDeleted == other.isDeleted && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "WebhookDeleteResponse{isDeleted=$isDeleted, additionalProperties=$additionalProperties}"
}
