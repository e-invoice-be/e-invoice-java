...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class com.e_invoice.api.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class com.e_invoice.api.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class com.e_invoice.api.** {
    <init>(...);
