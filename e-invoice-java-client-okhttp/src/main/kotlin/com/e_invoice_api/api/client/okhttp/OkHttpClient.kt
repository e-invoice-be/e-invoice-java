...
import com.e_invoice_api.api.core.http.HttpClient
import com.e_invoice_api.api.core.http.HttpMethod
import com.e_invoice_api.api.core.http.HttpRequest
import com.e_invoice_api.api.core.http.HttpRequestBody
import com.e_invoice_api.api.core.http.HttpResponse
import com.e_invoice_api.api.errors.EInvoiceIoException
...
private constructor(private val okHttpClient: okhttp3.OkHttpClient, private val baseUrl: HttpUrl) :
    ...
    override fun execute(request: HttpRequest, requestOptions: RequestOptions): HttpResponse {
        ...
        return try {
            ...
            throw EInvoiceIoException("Request failed", e)
        } finally {
            request.body?.close()
        }
    }
    ...
    private fun newCall(request: HttpRequest, requestOptions: RequestOptions): Call {
        ...
        val logLevel =
            when (System.getenv("E_INVOICE_LOG")?.lowercase()) {
