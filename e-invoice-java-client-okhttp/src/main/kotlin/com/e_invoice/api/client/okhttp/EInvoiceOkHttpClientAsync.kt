...
import com.e_invoice.api.client.EInvoiceClientAsyncImpl
...
/**
 * A class that allows building an instance of [EInvoiceClientAsync] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class EInvoiceOkHttpClientAsync private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [EInvoiceClientAsync]. */
         ...
         */
        @JvmStatic fun fromEnv(): EInvoiceClientAsync = builder().fromEnv().build()
    }

    /** A builder for [EInvoiceOkHttpClientAsync]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [EInvoiceClientAsync].
         *
