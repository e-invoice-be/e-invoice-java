...
/**
 * A class that allows building an instance of [EInvoiceClient] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class EInvoiceOkHttpClient private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [EInvoiceClient]. */
         ...
         */
        @JvmStatic fun fromEnv(): EInvoiceClient = builder().fromEnv().build()
    }

    /** A builder for [EInvoiceOkHttpClient]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [EInvoiceClient].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): EInvoiceClient =
            EInvoiceClientImpl(
                clientOptions
                    .httpClient(
